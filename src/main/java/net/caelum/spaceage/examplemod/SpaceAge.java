package net.caelum.spaceage.examplemod;

import net.caelum.spaceage.examplemod.blocks.ModBlocks;
...
public class SpaceAge {
    ...
    public SpaceAge(IEventBus modEventBus, ModContainer modContainer) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            ...
            event.accept(ModItems.BERYLLIUM_INGOT);
        ...
        if(event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.accept(ModBlocks.BERYLLIUM_BLOCK);
